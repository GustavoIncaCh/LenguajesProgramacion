...
msg0 db "Calculadora 4 operaciones",0Dh,0Ah
     db "Vamos a obtener los 4 resultados, cuidado con la division y resta",0Dh,0Ah,'$'
msg1 db 0Dh,0Ah, 0Dh,0Ah, 'Ingresa el primer numero: $'
;msg2 db "enter the operator:    +  -  *  /     : $"
msg3 db "Ingresa el segundo numero: $"
msg4 db  0dh,0ah , 'El resultado aproximado de la op + es: $'
msg5 db  0dh,0ah , 'El resultado aproximado de la op - es: $'
msg6 db  0dh,0ah , 'El resultado aproximado de la op * es: $'
msg7 db  0dh,0ah , 'El resultado aproximado de la op / es: $'
 
msg8 db 0dh,0ah ,'Fin de calculadora presiona cualquier tecla... ', 0Dh,0Ah, '$'
